...
$bg_colors = ["rgba(166, 130, 255, 1)","rgba(113, 90, 255, 1)","rgba(88, 135, 255, 1)","rgba(85, 193, 255, 1)","rgba(16, 46, 74, 1)"];
$bg_colors_trans = ["rgba(166, 130, 255, 0.85)","rgba(113, 90, 255, 0.85)","rgba(88, 135, 255, 0.85)","rgba(85, 193, 255, 0.85)","rgba(16, 46, 74, 0.85)"];
